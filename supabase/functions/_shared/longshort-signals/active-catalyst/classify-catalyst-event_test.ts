...
Deno.test('(4) partnership: noun + verb', () => {
  ...
  // Word-boundary matching prevents the verb "partners" from spuriously
  // matching inside the noun "partnership" — without boundaries this case
  // would silently pass the verb gate.
