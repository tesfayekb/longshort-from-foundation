...
| D | ACT-574 (**new — 2026-07-24; charter**) | entry-day-offset grid — cells A/B/C timing study of ADMITTED design (T1@T+2, T2@T+1) with mark-path curve; deliverable = one table + curve + one-line answer | **Weekend build + status-quo tie rule** (winning offset must WIN or TIE its column at n≥1000 pooled per tier; else → operator ruling with bps + $/yr at BLEND) | 2026-07-24 | weekend | `docs/06-tracking/ACT-574-charter-entry-day-offset-grid.md`; independent of ACT-573 |
