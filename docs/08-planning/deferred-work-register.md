...
| D | ACT-571 (**new — 2026-07-24; charter**) | overshoot universe-refresh source re-point Polygon `I:RUT` → IVV+IJH composite (reuse `parseIsharesCsv` + fetch primitives from ACT-548); sanity band `[850,950]` unchanged; provenance `source='ivv_ijh_composite'`; delete Polygon `I:RUT` from default path (probe-only retained); 7-test set; ONE manual acceptance run then Monday-10Z scheduled fire proof-point | **HARD GATE — Monday 2026-07-27 10:00:00Z** (else 4th silent Monday; INC-140 remains open) | 2026-07-24 | 2026-07-27 10:00Z | `docs/06-tracking/ACT-571-charter-refresh-repoint.md`; INC-140; INC-139 (proof-point); ACT-548 (seeding reuse target); DEC-023; DEC-034 clause 4 |
