...
| D-SCHEDULED | L-02 entry-minute corpus study — **THIS WEEKEND 2026-07-26/27** | Per operator's implementation-calendar lock (2026-07-25): substrate owned (MIG-167 `overshoot_minute_bars`, ≥95% coverage from 2026-07-01). Execute R-007 entry-side cost curve at 09:35..09:45 ET, k=1000 bootstrap CI, monotonicity envelope. Gates as chartered (`docs/06-tracking/charters/L-02-entry-minute-timing.md` §2). Deliverable = `docs/06-tracking/L-02-cost-curve.md`. Adoption ⟺ ALL 6 gates green (Δ ≥ 5 bps monotone). | weekend window | 2026-07-25 | 2026-07-27 | `docs/06-tracking/charters/L-02-entry-minute-timing.md`; MIG-167 substrate |
| D-SCHEDULED | L-01 limit-ladder A/B — **BUILD Sun 2026-07-26, LIVE from Mon 2026-07-27 open** | Per implementation-calendar lock: Sunday = arm-B tighter-limit code path in `overshoot-entry-run` (limit anchored −10 bps closer to quote-mid), per-admit coin-flip randomization writing `overshoot_lots.metadata.limit_arm ∈ {A,B}`. Monday 2026-07-27 13:35Z = A/B live, 90-day window (max 120 days per G-4 fail-open). Gates: G-1 fill_rate ≥ 88% & |Δ| ≤ 4pts, G-2 entry_slip ≤ +20 bps & <ctrl, G-3 paired-t p<0.10, G-4 n≥200/arm, G-5 dollar-weighted primary, G-6 fwd-5d ≥ ctrl−30 bps. Weekly receipt to `docs/06-tracking/L-01-weekly-receipts.md`. | Sun build; Mon live; ~90-day close ≈ 2026-10-27 | 2026-07-25 | 2026-10-27 | `docs/06-tracking/charters/L-01-limit-ladder-tightening.md`; ACT-506 (~−50 bps limit→fill basis) |
