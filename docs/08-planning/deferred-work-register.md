...
| D-SCHEDULED | L-01 limit-ladder A/B — **ARM Sun 2026-07-26, A/B LIVE Mon 2026-07-27 13:35Z** (amended 2026-07-25 — rolling-until-gates-clear) | Per implementation-calendar lock + **L-01 charter amendment 2026-07-25**: Sunday = arm-B tighter-limit code path in `overshoot-entry-run` (limit anchored −10 bps closer to quote-mid), per-admit coin-flip randomization writing `overshoot_lots.metadata.limit_arm ∈ {A,B}`. Monday 2026-07-27 13:35Z = A/B live. Window is **rolling-until-gates-clear** — 90/120-day caps STRUCK; first-verdict look at n ≥ 100/arm (~4 weeks) is informational only. Gates: G-1 fill_rate ≥ 88% & |Δ| ≤ 4pts, G-2 entry_slip ≤ +20 bps & <ctrl, G-3 paired-t p<0.10, G-4 n≥200/arm, G-5 dollar-weighted primary, G-6 fwd-5d ≥ ctrl−30 bps. Weekly receipt to `docs/06-tracking/L-01-weekly-receipts.md`. **Launch-independence:** paper lane runs continuously past ACT-577 mid-Aug live date; this lever adopts post-launch on its own evidence. | arm Sun 07-26; live Mon 07-27; **rolling — no calendar deadline** | 2026-07-25 | rolling | `docs/06-tracking/charters/L-01-limit-ladder-tightening.md` (amended 2026-07-25); ACT-506 (~−50 bps limit→fill basis) |
