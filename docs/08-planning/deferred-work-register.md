...
| D | ACT-573 (**new — 2026-07-24; charter**) | refused-winners forensics — SQL/study of REFUSED short-candidate pool (12 sessions); apples-to-apples per-tier entry/exit basis; status-quo-bias tie rule pre-committed | **Weekend Phase-1 SQL + corpus-graduation gate** (INSUFFICIENT-N tags on thin cells; verdict = adopt / hold / operator ruling) | 2026-07-24 | weekend | `docs/06-tracking/ACT-573-charter-refused-winners-forensics.md`; ACT-569 (short-arm feed) |
