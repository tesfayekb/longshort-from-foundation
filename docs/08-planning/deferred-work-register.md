...
| **Status** | **REGISTERED 2026-06-30 at ACT-352 — RIDE-ALONG WITH THE DEC-071 BUILD** (the §6.5 shadow variant `reversal_ungated` is stood up in the same weekend-build PR as the live gated reversal). Phase-7 (FP-058) consumes the accrued comparator. |
...
| **Status** | **REGISTERED 2026-06-30 at ACT-352 — PHASE-7-GATED, MEASUREMENT-ONLY** (no compute change implied today; pre-data tuning of a CRITICAL signal is p-hacking, which DEC-071 clause b explicitly forbids). |
