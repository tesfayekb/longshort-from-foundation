...
| D | ACT-548 cell-add candidate (**new — 2026-07-25 from ACT-573 §3**) | short-side S_08_10 / S_10_INF × drawdown-bucket-4 × momentum-q-5 corpus study; verdict vs 42.42 bps/slot-day floor + arrival_count + monotone-stability + regime-conditional | **BLOCKED on ACT-574 Phase-1** (LANDED 2026-07-25 ✓) → ready to slot after ACT-574 Phase-2 | 2026-07-25 | weekend/mid-week | `docs/06-tracking/ACT-548-cell-add-candidate-drawdown-b4-shorts.md`; ACT-573 §3 feeder |
