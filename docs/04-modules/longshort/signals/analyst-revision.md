...
**Status:** live (**ARMED + DEC-043-pattern attestation CLOSED 2026-06-12.**
First natural fire 2026-06-11 21:00 UTC: `cron.job_run_details` jobid=89
runid=147999 start=`2026-06-11 21:00:00.339738+00` end=`21:00:00.373725+00`
status=`succeeded`; cron-attributable `signal_compute_log` run
`3f58a03e-af4e-48fa-9ae5-53fef6e07118` started_at=`2026-06-11 21:00:01.214+00`
as_of_date=`2026-06-11` outcome=`completed` universe_size=839
persisted_count=208 skip_counts.no_revisions_in_window=345
skip_counts.revision_prior_unavailable=286 — conservation `345+286+208=839 ✓`;
`signal_observations` for as_of=2026-06-11 obs_present=208 z_mean=−0.007514
